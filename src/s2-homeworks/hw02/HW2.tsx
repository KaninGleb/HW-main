...
export const filterAffairs = (affairs: AffairType[], newFilter: FilterType): AffairType[] => {
    if (newFilter === 'all') return affairs;
    return affairs.filter(affair => affair.priority === newFilter);
}
